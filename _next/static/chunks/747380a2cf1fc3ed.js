(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 48013, (e, t, n) => {
    e.e,
    t.exports = function() {
        var t = [function(t, n) {
            var i, o = {};
            ...
            o.extend = function(e, t) {
                ...
                for (var r = n; r < arguments.length; r++) {
                    ...
                    if (a)
                        for (var s in a)
                            i && a[s] && a[s].constructor === Object ? e[s] && e[s].constructor !== Object ? e[s] = a[s] : (e[s] = e[s] || {},
                            o.extend(e[s], i, a[s])) : e[s] = a[s]
                }
                return e
            }
            ,
            ...
            o.set = function(e, t, n, i, r) {
                ...
                return o.get(e, t, 0, -1)[a[a.length - 1]] = n,
                n
            }
            ,
            ...
            o.chain = function() {
                ...
                var i = function() {
                    for (var t, n = Array(arguments.length), i = 0, o = arguments.length; i < o; i++)
                        n[i] = arguments[i];
        ...
        , function(e, t, n) {
            ...
            i.inertia = function(e, t) {
                for (var n, i, r = 0, a = 0, s = 0; s < e.length; s++)
                    i = (s + 1) % e.length,
                    r += (n = Math.abs(o.cross(e[i], e[s]))) * (o.dot(e[i], e[i]) + o.dot(e[i], e[s]) + o.dot(e[s], e[s])),
                    a += n;
                return t / 6 * (r / a)
            }
            ,
            ...
            i.chamfer = function(e, t, n, i, a) {
                ...
                for (var s = [], l = 0; l < e.length; l++) {
                    ...
                    var f = o.normalise({
                      ...
                      , g = o.normalise(o.mult(o.add(f, m), .5))
                      , x = o.sub(u, o.mult(g, v))
                      , h = n;
                    -1 === n && (h = 1.75 * Math.pow(p, .32)),
                    (h = r.clamp(h, i, a)) % 2 == 1 && (h += 1);
                    for (var b = Math.acos(o.dot(f, m)) / h, S = 0; S < h; S++)
            ...
            i.isConvex = function(e) {
                ...
                for (t = 0; t < a; t++)
                    if (n = (t + 1) % a,
                    i = (t + 2) % a,
                    (o = (e[n].x - e[t].x) * (e[i].y - e[n].y) - (e[n].y - e[t].y) * (e[i].x - e[n].x)) < 0 ? r |= 1 : o > 0 && (r |= 2),
                    3 === r)
                        return !1;
                return 0 !== r || null
            }
            ...
            i.hull = function(e) {
                ...
                n = 0; n < e.length; n += 1) {
                    for (t = e[n]; r.length >= 2 && 0 >= o.cross3(r[r.length - 2], r[r.length - 1], t); )
                        r.pop();
                    r.push(t)
                }
                for (n = e.length - 1; n >= 0; n -= 1) {
                    for (t = e[n]; i.length >= 2 && 0 >= o.cross3(i[i.length - 2], i[i.length - 1], t); )
                        i.pop();
                    i.push(t)
                }
                return i.pop(),
        ...
        , function(e, t, n) {
            ...
            o.setVertices = function(e, t) {
                ...
                o.setInertia(e, o._inertiaScale * r.inertia(e.vertices, e.mass)),
            ...
            o.setPosition = function(e, t, n) {
                ...
                e.velocity.x = i.x,
                e.velocity.y = i.y,
                e.speed = a.magnitude(i)) : (e.positionPrev.x += i.x,
            ...
            o.scale = function(e, t, n, i) {
                ...
                for (var l = 0; l < e.parts.length; l++) {
                    ...
                    o.setInertia(d, o._inertiaScale * r.inertia(d.vertices, d.mass)),
                    r.translate(d.vertices, {
                        x: d.position.x,
                        y: d.position.y
                    }),
                ...
                e.isStatic || (o.setMass(e, e.density * a),
                o.setInertia(e, s))),
            ...
            o.update = function(e, t) {
                ...
                e.deltaTime = t,
                e.angularVelocity = (e.angle - e.anglePrev) * s * i + e.torque / e.inertia * n,
                e.anglePrev = e.angle,
        ...
        , function(e, t, n) {
            ...
            a.collides = function(e, t, n) {
                if (a._overlapAxes(o, e.vertices, t.vertices, e.axes),
                o.overlap <= 0 || (a._overlapAxes(r, t.vertices, e.vertices, t.axes),
                r.overlap <= 0))
                    return null;
            ...
            a._overlapAxes = function(e, t, n, i) {
                var o, r, a, s, l, c, u = t.length, d = n.length, p = t[0].x, f = t[0].y, m = n[0].x, v = n[0].y, y = i.length, g = Number.MAX_VALUE, x = 0;
                for (l = 0; l < y; l++) {
                    var h = i[l]
                      , b = h.x
                      , S = h.y
            ...
            a._findSupports = function(e, t, n, o) {
                var r, a, s, l = t.vertices, c = l.length, u = e.position.x, d = e.position.y, p = n.x * o, f = n.y * o, m = l[0], v = m, y = p * (u - v.x) + f * (d - v.y);
                for (s = 1; s < c; s += 1)
                    (a = p * (u - (v = l[s]).x) + f * (d - v.y)) < y && (y = a,
                    m = v);
                return (y = p * (u - (r = l[(c + m.index - 1) % c]).x) + f * (d - r.y),
                p * (u - (v = l[(m.index + 1) % c]).x) + f * (d - v.y) < y) ? (i[0] = m,
                i[1] = v) : (i[0] = m,
                i[1] = r),
                i
            }
        ...
        , function(e, t, n) {
            ...
            i.create = function(e) {
                ...
                var t = e.bodyA ? r.add(e.bodyA.position, e.pointA) : e.pointA
                  ...
                  , i = r.magnitude(r.sub(t, n));
                e.length = void 0 !== e.length ? e.length : i,
                e.id = e.id || c.nextId(),
                ...
                return 0 === e.length && e.stiffness > .1 ? (o.type = "pin",
                o.anchors = !1) : e.stiffness < .9 && (o.type = "spring"),
                e.render = c.extend(o, e.render),
                e
            }
            ,
            ...
            i.solve = function(e, t) {
                ...
                if (n || o) {
                    ...
                    l && c) {
                        ...
                        var p, f, m, v, y, g = (d - e.length) / d, x = e.stiffness >= 1 || 0 === e.length ? e.stiffness * t : e.stiffness * t * t, h = e.damping * t, b = r.mult(u, g * x), S = (n ? n.inverseMass : 0) + (o ? o.inverseMass : 0), w = S + ((n ? n.inverseInertia : 0) + (o ? o.inverseInertia : 0));
                        if (h > 0) {
                            var A = r.create();
                            m = r.div(u, d),
                            y = r.sub(o && r.sub(o.position, o.positionPrev) || A, n && r.sub(n.position, n.positionPrev) || A),
                            v = r.dot(m, y)
                        }
                        ...
                        n.position.x -= b.x * f,
                        n.position.y -= b.y * f,
                        h > 0 && (n.positionPrev.x -= h * m.x * v * f,
                        n.positionPrev.y -= h * m.y * v * f),
                        ...
                        o.position.x += b.x * f,
                        o.position.y += b.y * f,
                        h > 0 && (o.positionPrev.x += h * m.x * v * f,
                        o.positionPrev.y += h * m.y * v * f),
            ...
            i.currentLength = function(e) {
                var t = (e.bodyA ? e.bodyA.position.x : 0) + (e.pointA ? e.pointA.x : 0)
                  ...
                  , i = (e.bodyB ? e.bodyB.position.x : 0) + (e.pointB ? e.pointB.x : 0)
                  , o = (e.bodyB ? e.bodyB.position.y : 0) + (e.pointB ? e.pointB.y : 0)
                  , r = t - i
                  , a = n - o;
        ...
        , function(e, t, n) {
            ...
            i.trapezoid = function(e, t, n, i, s, l) {
                ...
                c = s < .5 ? "L 0 0 L " + d + " " + -i + " L " + p + " " + -i + " L " + f + " 0" : "L 0 0 L " + p + " " + -i + " L " + f + " 0";
                var m = {
                ...
                if (l.chamfer) {
                    var v = l.chamfer;
                    m.vertices = o.chamfer(m.vertices, v.radius, v.quality, v.qualityMin, v.qualityMax),
                    delete l.chamfer
                }
            ...
            i.fromVertices = function(e, t, n, i, c, u, d, p) {
                var f, m, v, y, g, x, h, b, S, w, A = r.getDecomp();
                for (f = !!(A && A.quickDecomp),
                i = i || {},
                v = [],
                c = void 0 !== c && c,
                u = void 0 !== u ? u : .01,
                ...
                S = 0; S < n.length; S += 1)
                    if (g = n[S],
                    (y = o.isConvex(g)) || f || r.warnOnce("Bodies.fromVertices: Install the 'poly-decomp' library and use Common.setDecomp or provide 'decomp' as a global to decompose concave vertices."),
                    y || !f)
                ...
                for (x = 0; x < v.length; x++)
                    v[x] = a.create(r.extend(v[x], i));
                if (c)
                    for (x = 0; x < v.length; x++) {
                        var C = v[x];
                        for (h = x + 1; h < v.length; h++) {
                            var _ = v[h];
                            if (s.overlaps(C.bounds, _.bounds)) {
                                var k = C.vertices
                                  , I = _.vertices;
                ...
                return v.length > 1 ? (m = a.create(r.extend({
                    parts: v.slice(0)
                }, i)),
                a.setPosition(m, {
                    x: e,
        ...
        , function(e, t, n) {
            ...
            i.collisions = function(e) {
                var t, n, o = e.pairs, a = e.bodies, s = a.length, l = i.canCollide, c = r.collides, u = e.collisions, d = 0;
                for (a.sort(i._compareBoundsX),
                t = 0; t < s; t++) {
                    var p = a[t]
                      , f = p.bounds
                      , m = p.bounds.max.x
                    ...
                    for (n = t + 1; n < s; n++) {
                        ...
                        if (S.min.x > m)
                            break;
                        if (!(v < S.min.y) && !(y > S.max.y) && (!g || !b.isStatic && !b.isSleeping) && l(p.collisionFilter, b.collisionFilter)) {
                            var w = b.parts.length;
                            if (h && 1 === w) {
                                var A = c(p, b, o);
                                A && (u[d++] = A)
                            } else
                                for (var P = +(x > 1), B = +(w > 1), M = P; M < x; M++)
                                    for (var C = p.parts[M], f = C.bounds, _ = B; _ < w; _++) {
                                        var k = b.parts[_]
                                          , S = k.bounds;
        ...
        , function(e, t, n) {
            ...
            i.use = function(e, t) {
                ...
                0 === e.uses.length)
                    return void o.warn("Plugin.use:", i.toString(e), "does not specify any dependencies to install.");
                for (var n = i.dependencies(e), r = o.topologicalSort(n), a = [], s = 0; s < r.length; s += 1)
                    if (r[s] !== e.name) {
                        ...
                        i.isUsed(e, l.name) || (i.isFor(l, e) || (o.warn("Plugin.use:", i.toString(l), "is for", l.for, "but installed on", i.toString(e) + "."),
                        l._warned = !0),
        ...
        , function(e, t, n) {
            ...
            ,
            i.update = function(e, t) {
                var n, p = d.now(), f = e.world, m = e.detector, v = e.pairs, y = e.timing, g = y.timestamp;
                t > i._deltaMax && d.warnOnce("Matter.Engine.update: delta argument is recommended to be less than or equal to", i._deltaMax.toFixed(3), "ms."),
                t = (void 0 !== t ? t : d._baseDelta) * y.timeScale,
                y.timestamp += t,
                y.lastDelta = t;
                var x = {
                ...
                for (r.preSolvePosition(v.list),
                n = 0; n < e.positionIterations; n++)
                    r.solvePosition(v.list, t, w);
                for (r.postSolvePosition(h),
                u.preSolveAll(h),
                n = 0; n < e.constraintIterations; n++)
                    u.solveAll(b, t);
                for (u.postSolveAll(h),
                r.preSolveVelocity(v.list),
                n = 0; n < e.velocityIterations; n++)
                    r.solveVelocity(v.list, t);
                return i._bodiesUpdateVelocities(h),
                v.collisionActive.length > 0 && l.trigger(e, "collisionActive", {
        ...
        , function(e, t, n) {
            ...
            i.preSolvePosition = function(e) {
                ...
                for (t = 0; t < o; t++)
                    (n = e[t]).isActive && (i = n.contactCount,
                    n.collision.parentA.totalContacts += i,
                    n.collision.parentB.totalContacts += i)
            }
            ,
            i.solvePosition = function(e, t, n) {
                var o, a, s, l, c, u, d, p, f = i._positionDampen * (n || 1), m = r.clamp(t / r._baseDelta, 0, 1), v = e.length;
                for (o = 0; o < v; o++)
                    ...
                    if (o.isActive && !o.isSensor) {
                        ...
                        for (n = 0; n < a; n++) {
                            ...
                            if (0 !== m || 0 !== v) {
                                var y = u.x * m + d.x * v
                                  , g = u.y * m + d.y * v;
                                l.isStatic || l.isSleeping || (l.positionPrev.x += y * l.inverseMass,
                                l.positionPrev.y += g * l.inverseMass,
                                l.anglePrev += l.inverseInertia * ((f.x - l.position.x) * g - (f.y - l.position.y) * y)),
                                c.isStatic || c.isSleeping || (c.positionPrev.x -= y * c.inverseMass,
                                c.positionPrev.y -= g * c.inverseMass,
                                c.anglePrev -= c.inverseInertia * ((f.x - c.position.x) * g - (f.y - c.position.y) * y))
                            }
                        }
                    }
                }
            ...
            i.solveVelocity = function(e, t) {
                var n, o, a, s, l = t / r._baseDelta, c = l * l * l, u = -i._restingThresh * l, d = i._restingThreshTangent, p = i._frictionNormalMultiplier * l, f = i._frictionMaxStatic, m = e.length;
                for (a = 0; a < m; a++) {
                    var v = e[a];
                    if (v.isActive && !v.isSensor) {
                        var y = v.collision
                          ...
                          , w = y.tangent.y
                          , A = v.inverseMass
                          , P = v.friction * v.frictionStatic * p
                          , B = v.contacts
                          , M = v.contactCount
                          , C = 1 / M
                          , _ = g.position.x - g.positionPrev.x
                        ...
                        for (s = 0; s < M; s++) {
                            var E = B[s]
                              ...
                              , z = (G = N < 0 ? 0 : G) * P;
                            W < -z || W > z ? (o = W > 0 ? W : -W,
                            (n = v.friction * (W > 0 ? 1 : -1) * c) < -o ? n = -o : n > o && (n = o)) : (n = W,
                            o = f);
                            var $ = L * b - F * h
                              , X = O * b - H * h
                              , Q = C / (A + g.inverseInertia * $ * $ + x.inverseInertia * X * X)
                              , Y = (1 + v.restitution) * U * Q;
                            if (n *= Q,
                            U < u)
                                E.normalImpulse = 0;
                            else {
                            ...
                            if (W < -d || W > d)
                                ...
                                E.tangentImpulse += n,
                                E.tangentImpulse < -o && (E.tangentImpulse = -o),
                                E.tangentImpulse > o && (E.tangentImpulse = o),
        ...
        , function(e, t, n) {
            ...
            ,
            i.update = function(e, t, n) {
                var i, r, a, s = o.update, l = o.create, c = o.setActive, u = e.table, d = e.list, p = d.length, f = p, m = e.collisionStart, v = e.collisionEnd, y = e.collisionActive, g = t.length, x = 0, h = 0, b = 0;
                for (a = 0; a < g; a++)
                    (r = (i = t[a]).pair) ? (r.isActive && (y[b++] = r),
                    s(r, i, n)) : (u[(r = l(i, n)).id] = r,
                    m[x++] = r,
                    d[f++] = r);
                for (a = 0,
                f = 0,
                p = d.length; a < p; a++)
                    ...
                    r.collision.bodyA.sleepCounter > 0 && r.collision.bodyB.sleepCounter > 0 ? d[f++] = r : (v[h++] = r,
                    delete u[r.id]));
                d.length !== f && (d.length = f),
                m.length !== x && (m.length = x),
                v.length !== h && (v.length = h),
        ...
        , function(e, t, n) {
            ...
            i.newtonsCradle = function(e, t, n, i, a) {
                for (var s = o.create({
                    ...
                    var u = l.circle(e + 1.9 * i * c, t + a, i, {
                        inertia: 1 / 0,
                        restitution: 1,
                        friction: 0,
                        frictionAir: 1e-4,
            ...
            i.update = function(e, t, n, o) {
                ...
                for (r = 0; r < t.length; r++) {
                    ...
                    if ((!f.isSleeping || o) && (!u.bounds || !(f.bounds.max.x < u.bounds.min.x) && !(f.bounds.min.x > u.bounds.max.x) && !(f.bounds.max.y < u.bounds.min.y) && !(f.bounds.min.y > u.bounds.max.y))) {
                        var m = i._getRegion(e, f);
                        if (!f.region || m.id !== f.region.id || o) {
                            (!f.region || o) && (f.region = m);
                            var v = i._regionUnion(m, f.region);
                            for (a = v.startCol; a <= v.endCol; a++)
                                for (s = v.startRow; s <= v.endRow; s++) {
                                    l = d[c = i._getBucketId(a, s)];
                                    var y = a >= m.startCol && a <= m.endCol && s >= m.startRow && s <= m.endRow
                                      , g = a >= f.region.startCol && a <= f.region.endCol && s >= f.region.startRow && s <= f.region.endRow;
                                    !y && g && g && l && i._bucketRemoveBody(e, l, f),
                                    (f.region === m || y && !g || o) && (l || (l = i._createBucket(d, c)),
        ...
        , function(e, t, n) {
            ...
            i.ray = function(e, t, n, r) {
                r = r || 1e-100;
                for (var a = o.angle(t, n), l = o.magnitude(o.sub(t, n)), c = (n.x + t.x) * .5, u = (n.y + t.y) * .5, d = s.rectangle(c, u, l, r, {
                    angle: a
            ...
            i.point = function(e, t) {
                for (var n = [], i = 0; i < e.length; i++) {
                    ...
                    if (a.contains(o.bounds, t))
                        for (var r = +(1 !== o.parts.length); r < o.parts.length; r++) {
                            var s = o.parts[r];
        ...
        , function(e, t, n) {
            ...
            var p = n(4)
              ...
              , g = n(2)
              , x = n(14);
            "u" > typeof window && (i = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
            ...
            d.lookAt = function(e, t, n, i) {
                ...
                e.bounds.max.x = o.min.x + c * v,
                e.bounds.min.y = o.min.y,
                e.bounds.max.y = o.min.y + u * y,
                i && (e.bounds.min.x += .5 * c - c * v * .5,
                e.bounds.max.x += .5 * c - c * v * .5,
                e.bounds.min.y += .5 * u - u * y * .5,
                e.bounds.max.y += .5 * u - u * y * .5),
                e.bounds.min.x -= n.x,
                e.bounds.max.x -= n.x,
                e.bounds.min.y -= n.y,
                e.bounds.max.y -= n.y,
            ...
            d.world = function(e, t) {
                var n, i = f.now(), o = e.engine, r = o.world, a = e.canvas, s = e.context, l = e.options, c = e.timing, p = m.allBodies(r), h = m.allConstraints(r), b = l.wireframes ? l.wireframeBackground : l.background, S = [], w = [], A = {
                    timestamp: o.timing.timestamp
                };
                if (y.trigger(e, "beforeRender", A),
                ...
                l.hasBounds) {
                    for (n = 0; n < p.length; n++) {
                        var P = p[n];
                        v.overlaps(P.bounds, e.bounds) && S.push(P)
                    }
                    for (n = 0; n < h.length; n++) {
                        var B = h[n]
                          ...
                          , _ = B.pointA
                          , k = B.pointB;
                        M && (_ = g.add(M.position, B.pointA)),
                        C && (k = g.add(C.position, B.pointB)),
                        _ && k && (v.contains(e.bounds, _) || v.contains(e.bounds, k)) && w.push(B)
                    }
                ...
                !l.wireframes || o.enableSleeping && l.showSleeping ? d.bodies(e, S, s) : (l.showConvexHulls && d.bodyConvexHulls(e, S, s),
                ...
                y.trigger(e, "afterRender", A),
                c.lastElapsed = f.now() - i
            }
            ,
            d.stats = function(e, t, n) {
                for (var i = e.engine, o = i.world, r = m.allBodies(o), a = 0, s = 0, l = 0; l < r.length; l += 1)
                    a += r[l].parts.length;
                var c = {
                    Part: a,
                    Body: r.length,
            ...
            d.performance = function(e, t) {
                var n = e.engine
                  ...
                  , c = i.engineUpdatesHistory
                  , u = i.engineElapsedHistory
                ...
                d.status(t, 10, 69, 60, 4, o.length, Math.round(w) + " fps", w / d._goodFps, function(e) {
                    return o[e] / v - 1
                }),
                ...
                d.status(t, 298, 69, 60, 4, r.length, y.toFixed(2) + " rt", 1 - y / d._goodFps, function(e) {
                    return r[e] / y - 1
                }),
                d.status(t, 370, 69, 60, 4, s.length, b.toFixed(2) + " x", b * b * b, function(e) {
                    return (s[e] / o[e] / b || 0) - 1
                })
            }
            ,
            d.status = function(e, t, n, i, o, r, a, s, l) {
                ...
                e.beginPath(),
                e.moveTo(t, n + 7 - o * f.clamp(.4 * l(0), -2, 2));
                for (var c = 0; c < i; c += 1)
                    e.lineTo(t + c, n + 7 - (c < r ? o * f.clamp(.4 * l(c), -2, 2) : 0));
                e.stroke(),
            ...
            d.constraints = function(e, t) {
                for (var n = 0; n < e.length; n++) {
                    ...
                    if (i.render.visible && i.pointA && i.pointB) {
                        var o, r, a = i.bodyA, s = i.bodyB;
                        if (o = a ? g.add(a.position, i.pointA) : i.pointA,
                        "pin" === i.render.type)
                            t.beginPath(),
                            t.arc(o.x, o.y, 3, 0, 2 * Math.PI),
                            t.closePath();
                        else {
                            if (r = s ? g.add(s.position, i.pointB) : i.pointB,
                            t.beginPath(),
                            t.moveTo(o.x, o.y),
                            "spring" === i.render.type)
                                for (var l, c = g.sub(r, o), u = g.perp(g.normalise(c)), d = Math.ceil(f.clamp(i.length / 5, 12, 20)), p = 1; p < d; p += 1)
                                    l = p % 2 == 0 ? 1 : -1,
                                    t.lineTo(o.x + c.x * (p / d) + u.x * l * 4, o.y + c.y * (p / d) + u.y * l * 4);
                            t.lineTo(r.x, r.y)
                        }
                        i.render.lineWidth && (t.lineWidth = i.render.lineWidth,
                        t.strokeStyle = i.render.strokeStyle,
                        t.stroke()),
                        i.render.anchors && (t.fillStyle = i.render.strokeStyle,
                        t.beginPath(),
                        t.arc(o.x, o.y, 3, 0, 2 * Math.PI),
            ...
            d.bodies = function(e, t, n) {
                e.engine;
                var i, o, r, a, s = e.options, l = s.showInternalEdges || !s.wireframes;
                for (r = 0; r < t.length; r++)
                    if ((i = t[r]).render.visible) {
                        for (a = +(i.parts.length > 1); a < i.parts.length; a++)
                            if ((o = i.parts[a]).render.visible) {
                                if (s.showSleeping && i.isSleeping ? n.globalAlpha = .5 * o.render.opacity : 1 !== o.render.opacity && (n.globalAlpha = o.render.opacity),
                                o.render.sprite && o.render.sprite.texture && !s.wireframes) {
                                    var u = o.render.sprite
                                      , d = c(e, u.texture);
                                    n.translate(o.position.x, o.position.y),
                                    n.rotate(o.angle),
                                    ...
                                    if (o.circleRadius)
                                        n.beginPath(),
                                        n.arc(o.position.x, o.position.y, o.circleRadius, 0, 2 * Math.PI);
                                    else {
                                        n.beginPath(),
                                        n.moveTo(o.vertices[0].x, o.vertices[0].y);
                                        for (var p = 1; p < o.vertices.length; p++)
                                            !o.vertices[p - 1].isInternal || l ? n.lineTo(o.vertices[p].x, o.vertices[p].y) : n.moveTo(o.vertices[p].x, o.vertices[p].y),
                                            o.vertices[p].isInternal && !l && n.moveTo(o.vertices[(p + 1) % o.vertices.length].x, o.vertices[(p + 1) % o.vertices.length].y);
                                        n.lineTo(o.vertices[0].x, o.vertices[0].y),
                                        n.closePath()
                                    }
                                    s.wireframes ? (n.lineWidth = 1,
                                    n.strokeStyle = e.options.wireframeStrokeStyle,
                                    n.stroke()) : (n.fillStyle = o.render.fillStyle,
            ...
            d.bodyWireframes = function(e, t, n) {
                var i, o, r, a, s, l = e.options.showInternalEdges;
                for (n.beginPath(),
                r = 0; r < t.length; r++)
                    if ((i = t[r]).render.visible)
                        for (s = +(i.parts.length > 1); s < i.parts.length; s++) {
                            for (o = i.parts[s],
                            n.moveTo(o.vertices[0].x, o.vertices[0].y),
                            a = 1; a < o.vertices.length; a++)
                                !o.vertices[a - 1].isInternal || l ? n.lineTo(o.vertices[a].x, o.vertices[a].y) : n.moveTo(o.vertices[a].x, o.vertices[a].y),
                                o.vertices[a].isInternal && !l && n.moveTo(o.vertices[(a + 1) % o.vertices.length].x, o.vertices[(a + 1) % o.vertices.length].y);
                            n.lineTo(o.vertices[0].x, o.vertices[0].y)
                        }
                n.lineWidth = 1,
                n.strokeStyle = e.options.wireframeStrokeStyle,
            ...
            d.bodyConvexHulls = function(e, t, n) {
                ...
                o = 0; o < t.length; o++)
                    if ((i = t[o]).render.visible && 1 !== i.parts.length) {
                        for (n.moveTo(i.vertices[0].x, i.vertices[0].y),
                        r = 1; r < i.vertices.length; r++)
                            n.lineTo(i.vertices[r].x, i.vertices[r].y);
                ...
                for (i = 0; i < t.length; i++) {
                    ...
                    for (r = +(a.length > 1); r < a.length; r++) {
                        ...
                        for (o = 0; o < s.vertices.length; o++)
                            ...
                            n.fillText(i + "_" + o, s.position.x + (s.vertices[o].x - s.position.x) * .8, s.position.y + (s.vertices[o].y - s.position.y) * .8)
                    }
                }
            }
            ,
            ...
            d.bodyBounds = function(e, t, n) {
                ...
                for (var o = 0; o < t.length; o++)
                    if (t[o].render.visible)
                        for (var r = t[o].parts, a = +(r.length > 1); a < r.length; a++) {
                            var s = r[a];
                    ...
                    if (l.render.visible)
                        if (s.showAxes)
                            for (r = +(c.length > 1); r < c.length; r++)
                                for (a = 0,
                                i = c[r]; a < i.axes.length; a++) {
                                    var u = i.axes[a];
                                    n.moveTo(i.position.x, i.position.y),
                                    n.lineTo(i.position.x + 20 * u.x, i.position.y + 20 * u.y)
                                }
                        else
                            for (r = +(c.length > 1); r < c.length; r++)
                                for (a = 0,
                                i = c[r]; a < i.axes.length; a++)
                                    n.moveTo(i.position.x, i.position.y),
                                    n.lineTo((i.vertices[0].x + i.vertices[i.vertices.length - 1].x) / 2, (i.vertices[0].y + i.vertices[i.vertices.length - 1].y) / 2)
                }
                ...
                r = 0; r < t.length; r++)
                    if ((i = t[r]).render.visible)
                        for (a = 0; a < i.parts.length; a++)
                            o = i.parts[a],
                            n.arc(o.position.x, o.position.y, 3, 0, 2 * Math.PI, !1),
                            n.closePath();
                for (s.wireframes ? n.fillStyle = "indianred" : n.fillStyle = "rgba(0,0,0,0.5)",
                n.fill(),
                n.beginPath(),
                r = 0; r < t.length; r++)
                    (i = t[r]).render.visible && (n.arc(i.positionPrev.x, i.positionPrev.y, 2, 0, 2 * Math.PI, !1),
                    n.closePath());
            ...
            d.bodyVelocity = function(e, t, n) {
                ...
                for (var i = 0; i < t.length; i++) {
                    var o = t[i];
                    if (o.render.visible) {
                        var r = p.getVelocity(o);
                        n.moveTo(o.position.x, o.position.y),
                        n.lineTo(o.position.x + r.x, o.position.y + r.y)
                    }
                }
                n.lineWidth = 3,
            ...
            d.collisions = function(e, t, n) {
                ...
                r = 0; r < t.length; r++)
                    if ((i = t[r]).isActive)
                        for (a = 0,
                        o = i.collision; a < i.contactCount; a++) {
                            var l = i.contacts[a].vertex;
                ...
                r = 0; r < t.length; r++)
                    ...
                    i.contactCount > 0)) {
                        var c = i.contacts[0].vertex.x
                          , u = i.contacts[0].vertex.y;
                        2 === i.contactCount && (c = (i.contacts[0].vertex.x + i.contacts[1].vertex.x) / 2,
                        u = (i.contacts[0].vertex.y + i.contacts[1].vertex.y) / 2),
                        o.bodyB === o.supports[0].body || !0 === o.bodyA.isStatic ? n.moveTo(c - 8 * o.normal.x, u - 8 * o.normal.y) : n.moveTo(c + 8 * o.normal.x, u + 8 * o.normal.y),
                        n.lineTo(c, u)
                    }
            ...
            d.separations = function(e, t, n) {
                var i, o, r, a, s, l = e.options;
                for (n.beginPath(),
                s = 0; s < t.length; s++)
                    if ((i = t[s]).isActive) {
                        r = (o = i.collision).bodyA;
                        var c = 1;
                        (a = o.bodyB).isStatic || r.isStatic || (c = .5),
                        a.isStatic && (c = 0),
                        n.moveTo(a.position.x, a.position.y),
                        n.lineTo(a.position.x - o.penetration.x * c, a.position.y - o.penetration.y * c),
                        c = 1,
                        a.isStatic || r.isStatic || (c = .5),
                        r.isStatic && (c = 0),
                        n.moveTo(r.position.x, r.position.y),
                        n.lineTo(r.position.x + o.penetration.x * c, r.position.y + o.penetration.y * c)
                    }
            ...
            r = function(e, t) {
                ...
                i.engineUpdatesHistory.length = Math.min(i.engineUpdatesHistory.length, o),
        ...
        , function(e, t, n) {
            ...
            o._smoothingLowerBound = .1,
            o._smoothingUpperBound = .9,
            o.create = function(e) {
                var t = s.extend({
                    delta: 1e3 / 60,
                    frameDelta: null,
            ...
            o.tick = function(e, t, n) {
                var l = s.now()
                  ...
                  , u = 0
                  , d = n - e.timeLastTick;
                if ((!d || !e.timeLastTick || d > Math.max(o._maxFrameDelta, e.maxFrameTime)) && (d = e.frameDelta || o._frameDeltaFallback),
                e.frameDeltaSmoothing) {
                    ...
                    d = i(e.frameDeltaHistory.slice(p.length * o._smoothingLowerBound, p.length * o._smoothingUpperBound)) || d
                }
                e.frameDeltaSnapping && (d = 1e3 / Math.round(1e3 / d)),
                e.frameDelta = d,
                e.timeLastTick = n,
                e.timeBuffer += e.frameDelta,
                e.timeBuffer = s.clamp(e.timeBuffer, 0, e.frameDelta + c * o._timeBufferMargin),
                ...
                r.trigger(e, "tick", m);
                for (var v = s.now(); c > 0 && e.timeBuffer >= c * o._timeBufferMargin; ) {
                    ...
                    var y = s.now() - l
                      , g = s.now() - v
                      , x = y + o._elapsedNextEstimate * g / u;
                    if (u >= f || x > e.maxFrameTime) {
                        e.lastUpdatesDeferred = Math.round(Math.max(0, e.timeBuffer / c - o._timeBufferMargin));
                        break
                    }
                }
            ...
            ,
            i = function(e) {
                for (var t = 0, n = e.length, i = 0; i < n; i += 1)
                    t += e[i];
                return t / n || 0
            }
        }
        ...
        , function(e, t, n) {
            ...
            i.pathToVertices = function(e, t) {
                !("u" > typeof window) || "SVGPathSeg"in window || o.warn("Svg.pathToVertices: SVGPathSeg not defined, a polyfill is required.");
                var n, r, a, s, l, c, u, d, p, f, m, v = [], y = 0, g = 0, x = 0;
                t = t || 15;
                ...
                for (u = c.concat(); y < a; ) {
                    ...
                    case "Q":
                    case "A":
                        h((s = e.getPointAtLength(y)).x, s.y, 0)
                    }
                    y += t
                }
                for (n = 0,
...
, 55869, e => {
    ...
    var t = e.i(43476)
      , n = e.i(71645)
      , i = e.i(48013);
    e.s(["default", 0, ({text: e="", highlightWords: o=[], highlightClass: r="highlighted", trigger: a="auto", backgroundColor: s="transparent", wireframes: l=!1, gravity: c=1, mouseConstraintStiffness: u=.2, fontSize: d="1rem"}) => {
        let p = (0,
        n.useRef)(null)
          , f = (0,
        n.useRef)(null)
        ...
        n.useEffect)( () => {
            if (!f.current)
                return;
            let t = e.split(" ").map(e => {
                let t = o.some(t => e.startsWith(t));
                return `<span class="word ${t ? r : ""}">${e}</span>`
            }
            ).join(" ");
        ...
        n.useEffect)( () => {
            if ("auto" === a)
                return void y(!0);
            if ("scroll" === a && p.current) {
                let e = new IntersectionObserver( ([t]) => {
                    t.isIntersecting && (y(!0),
                    e.disconnect())
                }
                ,{
                    threshold: .1
        ...
        n.useEffect)( () => {
            if (!v)
                return;
            let {Engine: e, Render: t, World: n, Bodies: o, Runner: r, Mouse: a, MouseConstraint: d} = i.default;
            if (!p.current || !m.current || !f.current)
                return;
            ...
            let b = t.create({
              ...
              , w = o.rectangle(g / 2, x + 25, g, 50, S)
              , A = o.rectangle(-25, x / 2, 50, x, S)
              , P = o.rectangle(g + 25, x / 2, 50, x, S)
              , B = o.rectangle(g / 2, -25, g, 50, S)
              , M = Array.from(f.current.querySelectorAll(".word")).map(e => {
                let t = e.getBoundingClientRect()
                  , n = t.left - y.left + t.width / 2
                  , r = t.top - y.top + t.height / 2
                  , a = o.rectangle(n, r, t.width, t.height, {
                    render: {
                        fillStyle: "transparent"
                    },
                    restitution: .8,
                ...
                return i.default.Body.setVelocity(a, {
                    x: (Math.random() - .5) * 5,
                    y: 0
                }),
                i.default.Body.setAngularVelocity(a, (Math.random() - .5) * .05),
                {
                    elem: e,
                    body: a
                }
            ...
            M.forEach( ({elem: e, body: t}) => {
                e.style.position = "absolute",
                e.style.left = `${t.position.x - t.bounds.max.x + t.bounds.min.x / 2}px`,
                e.style.top = `${t.position.y - t.bounds.max.y + t.bounds.min.y / 2}px`,
                e.style.transform = "none"
            }
            );
            let C = a.create(p.current)
              , _ = d.create(h, {
                mouse: C,
                constraint: {
                    stiffness: u,
            ...
            b.mouse = C,
            n.add(h.world, [w, A, P, B, _, ...M.map(e => e.body)]);
            let k = r.create();
            r.run(k, h),
            t.run(b);
            let I = () => {
                M.forEach( ({body: e, elem: t}) => {
                    let {x: n, y: i} = e.position;
                    t.style.left = `${n}px`,
                    t.style.top = `${i}px`,
                    t.style.transform = `translate(-50%, -50%) rotate(${e.angle}rad)`
                }
                ),
                i.default.Engine.update(h),
            ...
            () => {
                t.stop(b),
                r.stop(k),
                b.canvas && m.current && m.current.removeChild(b.canvas),
                n.clear(h.world, !1),
                e.clear(h)
            }
        }
        ...
        t.jsxs)("div", {
            ...
            onClick: "click" === a ? g : void 0,
            onMouseEnter: "hover" === a ? g : void 0,
            style: {
                position: "relative",
                overflow: "hidden"
            },
